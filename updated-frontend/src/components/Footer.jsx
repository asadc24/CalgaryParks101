...
const Footer = () => {
  return (
    <div className='mt-14 mx-auto px-4 border-t-[1px]'>
        ...
        <div className=' max-w-[1024px] mx-auto px-4 grid lg:grid-cols-3 gap-8 text-gray-300'>
            <div >
            ...
            <div className='lg:col-span-2 flex justify-between mt-6'>
                ...
                <div>
                    <a className='font-medium text-gray-400' href='https://github.com/asadc24/CalgaryParks101'>Github</a>
